...
% Пример использования:
% не_вернули_книги_изданные_до(1990, Фамилия_студента, Курс_студента).
nondeterm не_вернули_книги_изданные_до(год_издания_книги, фамилия_студента, курс_студента)

% 3) кто из студентов не вернул книги заданной тематики (например, похимии).
% Пример использования:
% студенты_не_вернувшие_книги_по("Химия", Фамилия_студента, Курс_студента).
nondeterm студенты_не_вернувшие_книги_по(название_книги, фамилия_студента, курс_студента)

nondeterm курс_студента_или(курс_студента, integer, integer)
...
не_вернули_книги_изданные_до(До_год, Фамилия_студента, Курс_студента) :-
	write("кто из студентов не вернул книги, изданные до "),write(До_год),write(" года: "),nl,
	не_вернул(Фамилия_студента, Курс_студента, Номер_книги),
	книга(_, Номер_книги, Год_издания),
	Год_издания < До_год.

студенты_не_вернувшие_книги_по(Название_книги, Фамилия_студента, Курс_студента) :-
	write("кто из студентов не вернул книги по "),write(Название_книги),nl,
	не_вернул(Фамилия_студента, Курс_студента, Номер_книги),
	книга(Название_книги, Номер_книги, _).
	
курс_студента_или(Курс_студента, A, B) :- Курс_студента = A or Курс_студента = B.
...
% Ответ:
% не_вернул(Фамилия_студента, 3, _).

% 2. перечислить фамилии студентов 2-го и 4-го курсов, которые пользуются услугами библиотеки;
% Ответ:
% курс_студента_или(Курс_студента, 2, 4), не_вернул(Фамилия_студента, Курс_студента, _).
...
% Ответ:
% студенты_не_вернувшие_книги_по("Физика", Фамилия_студента, Курс_студента).
