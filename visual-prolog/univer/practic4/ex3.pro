...
% применение: закрепленные_сотрудники(Id_животного, Имя_ж, Пол_ж, Вид, Id_сотрудника, Фамилия, Имя_с, Отчество, Дата_рождения_с, Телефон).
nondeterm закрепленные_сотрудники(id_животного, имя, пол, вид, id_сотрудника, фамилия, имя, отчество, дата_рождения, телефон)
...
закрепленные_сотрудники(Id_животного, Имя_ж, Пол_ж, Вид, Id_сотрудника, Фамилия, Имя_с, Отчество, Дата_рождения_с, Телефон) :-
	питомец(Id_животного, Имя_ж, _, Пол_ж, Вид, _, Id_сотрудника),
